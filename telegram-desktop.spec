...
%changelog
* Fri Sep 18 2026 Danila Vershinin <info@getpagespeed.com> - 7.2.9-1
- upstream release v7.2.9


* Fri Sep 11 2026 Danila Vershinin <info@getpagespeed.com> - 7.2.8-1
- Fixed crashes caused by invalid Lottie files.
...
- Updated autoupdate manifest source for improved reliability.
...
* Wed Aug 26 2026 Danila Vershinin <info@getpagespeed.com> - 7.1.2-1
- upstream release v7.1.2


* Sun Aug 23 2026 Danila Vershinin <info@getpagespeed.com> - 7.1.1-1
- upstream release v7.1.1
...
- Fix crash in some video file viewers.
...
* Wed Mar 04 2026 Danila Vershinin <info@getpagespeed.com> - 6.6.2-1
- Fix media file editing functionality.
- Resolve admin rights issue in legacy groups for tag editing.
- Correct opening of emoji packs from custom emoji clicks.
...
- Introduced Gift Crafting functionality.
- Colored buttons for bot interactions.
- Enhanced search functionality in Settings.


* Mon Jan 12 2026 Danila Vershinin <info@getpagespeed.com> - 6.4.2-1
- Fixed non-closing popup menu items.
- Resolved crash during profile section resizing.
- Corrected text glitches from render optimizations.
...
* Fri Nov 21 2025 Danila Vershinin <info@getpagespeed.com> - 6.3.2-1
- Improved support for gift auctions.
- Reordered stories in My Profile albums.
- Fixed bugs in new profile cover design.
- Added Saved Music to data export.


* Tue Nov 18 2025 Danila Vershinin <info@getpagespeed.com> - 6.3.1-1
- Reordered saved music in My Profile.
- Fixed cover overlapping information in My Profile.
- Resolved issues opening stories from My Profile.
- Fixed media viewer breaking after Live Stories.
- Addressed several potential crashes.


* Sun Nov 16 2025 Danila Vershinin <info@getpagespeed.com> - 6.3.0-1
- Added support for Gift auctions.
- Introduced support for Live stories.
- Updated design for profile pages.


* Thu Oct 23 2025 Danila Vershinin <info@getpagespeed.com>
- upstream release v6.2.4


* Mon Oct 13 2025 Danila Vershinin <info@getpagespeed.com>
- upstream release v6.2.3


* Sat Oct 11 2025 Danila Vershinin <info@getpagespeed.com>
- upstream release v6.2.2


* Tue Oct 07 2025 Danila Vershinin <info@getpagespeed.com>
- upstream release v6.1.4


* Mon Sep 08 2025 Danila Vershinin <info@getpagespeed.com>
- upstream release v6.1.3


* Fri Sep 05 2025 Danila Vershinin <info@getpagespeed.com>
- upstream release v6.1.2


* Wed Sep 03 2025 Danila Vershinin <info@getpagespeed.com>
- upstream release v6.1.1


* Tue Sep 02 2025 Danila Vershinin <info@getpagespeed.com>
- upstream release v6.1.0


* Sun Aug 03 2025 Danila Vershinin <info@getpagespeed.com>
- upstream release v6.0.2
